function knobSettings  = altHumanColorMatcher(testLight, primaries)

% knobSettings = altHumanColorMatcher(testLight, primaries)
%
% Simulate a color-deficient human observer in a color-matching
% experiment.
%
...
error('Code has been removed - this is just a stub file for documentation.  Execute the p-file instead.');
